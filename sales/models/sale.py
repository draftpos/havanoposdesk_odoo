...
class Sale(models.Model):
    ...
    account_id = fields.Many2one('havanoposdesk.account', string='Deposit Account', domain="[('tenant_id', '=', tenant_id), ('type', 'in', ['Cash', 'Bank']), ('active', '=', True)]", default=_default_account_id)
